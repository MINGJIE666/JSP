...
#plt.plot(x, y2, marker='^', ms=25,  lw=3, color='b', label='HTSFP1$_{5}$')
plt.plot(x, y3, marker='s', ms=25,  lw=3, color='b', label='HTSFP1')
...
plt.tight_layout()
plt.savefig('experiment1_1.eps')
plt.savefig('experiment1_1.pdf')
plt.show()