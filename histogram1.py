...
adjacency = [55, 13, 14]  # adjacency的比例
precedence = [91, 40, 42]  # precedence的比例
...
# 添加标签和标题
ax.set_xlabel(r'Solution Quality', fontsize=12)
ax.set_ylabel(r'Proportion ($\%$)', fontsize=12)
ax.set_xticks(x)
...
# 显示图表
plt.tight_layout()
plt.savefig('histogram1.pdf', format='pdf')
plt.show()
